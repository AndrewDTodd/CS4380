...
void DIV::Op(Process_4380* executingProcess)
{
	...
	else
	{
		...
		{
		case 16:
			throw VMFramework::protection_fault("DIV used to modify PC");
			break;

		case 17:
			throw VMFramework::protection_fault("DIV used to modify SL");
			break;

		case 18:
			throw VMFramework::protection_fault("DIV used to modify SB");
			break;

		case 19:
			throw VMFramework::protection_fault("DIV used to modify SP");
			break;

		case 20:
			throw VMFramework::protection_fault("DIV used to modify FP");
			break;

		case 21:
			throw VMFramework::protection_fault("DIV used to modify HP");
		}
#else
