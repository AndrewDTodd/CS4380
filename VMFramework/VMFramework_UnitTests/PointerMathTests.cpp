...
TEST(PointerMathTests, Validate_AlignBackward)
{
    ...
    EXPECT_EQ(PointerMath::AlignBackward(address, 64), reinterpret_cast<void*>(0x12345600));
}
...
TEST(PointerMathTests, Validate_AlignBackwardConst)
{
    ...
    EXPECT_EQ(PointerMath::AlignBackward(address, 64), reinterpret_cast<const void*>(0x12345600));
}
...
TEST(PointerMathTests, Validate_AlignForwardAdjustment)
{
    ...
    EXPECT_EQ(PointerMath::AlignForwardAdjustment(address, 32), 24);
    EXPECT_EQ(PointerMath::AlignForwardAdjustment(address, 64), 56);
}
...
TEST(PointerMathTests, Validate_AlignForwardAdjustmentWithHeader)
{
    ...
    EXPECT_EQ(PointerMath::AlignForwardAdjustmentWithHeader(nullptr, 8, 1), 1);
    EXPECT_EQ(PointerMath::AlignForwardAdjustmentWithHeader(nullptr, 16, 4), 4);
    ...
    EXPECT_EQ(PointerMath::AlignForwardAdjustmentWithHeader(address, 16, 4), 4);
...
TEST(PointerMathTests, Validate_AlignBackwardAdjustment)
{
    ...
    EXPECT_EQ(PointerMath::AlignBackwardAdjustment(address, 16), 0);
    EXPECT_EQ(PointerMath::AlignBackwardAdjustment(address, 32), 16);
}
...
TEST(PointerMathTests, Validate_Add)
{
    ...
    EXPECT_EQ(PointerMath::Add(address, 100), reinterpret_cast<void*>(0x1234571C));
}
...
TEST(PointerMathTests, Validate_AddConst)
{
    ...
    EXPECT_EQ(PointerMath::Add(address, 100), reinterpret_cast<const void*>(0x1234571C));
}
...
TEST(PointerMathTests, Validate_Subtract)
{
    ...
    EXPECT_EQ(PointerMath::Subtract(address, 100), reinterpret_cast<void*>(0x123455D8));
}
...
TEST(PointerMathTests, Validate_SubtractConst)
{
    ...
    EXPECT_EQ(PointerMath::Subtract(address, 100), reinterpret_cast<const void*>(0x123455D8));
}