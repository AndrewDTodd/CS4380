...
namespace ASMFramework
{
	...
	const std::regex ASMDirective::asciiPattern = std::regex(R"delim((^'.'$))delim", std::regex_constants::ECMAScript);
	const std::regex ASMDirective::asciiEscape = std::regex(R"delim((^'\\[tnr]'$))delim", std::regex_constants::ECMAScript);
