...
namespace ASMFramework
{
	...
	const std::regex ASMInstruction::asciiPattern = std::regex(R"delim((^'.'$))delim", std::regex_constants::ECMAScript);
	const std::regex ASMInstruction::asciiEscape = std::regex(R"delim((^'\\[tnr]'$))delim", std::regex_constants::ECMAScript);
